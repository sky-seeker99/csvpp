...
int main(int argc, char* argv[]){
  printf("CSV File -> XLS File Adding Extend Version Program Ver 1.04\n\n");
  ...
  if (p_csvdir == NULL) {
    printf("use:csvmake4 xlsfile in_dir [-nv] [-new] [-proc] [filter] [ext]\n");
    printf("ex :csvmake4 c:\\aaa.xls c:\\csv\n");
    printf("ex :csvmake4 c:\\aaa.xls c:\\csv -nv -new\n");
    printf("ex :csvmake4 c:\\aaa.xls c:\\csv tabcsv txt\n");
    delete csvmake;
    return 1;
  }
