...
void help(){
  printf("use:retconv4 in_file out_file [-buff buffer_size]\n");
  printf("ex :retconv4 aaa.csv bbb.csv\n");
}


int main(int argc, char* argv[]){
  printf("file-maker return conversion(0x0a->0x0b) Ver 1.05\n\n");
  ...
  cellStringReplace(file_inf->in_fp,file_inf->out_fp,aa,bb);
  file_inf->file_close();
